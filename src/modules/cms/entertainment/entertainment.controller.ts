...
export class EntertainmentController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Return all entertainment.',
    type: [entertainment],
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Return a single entertainment.',
    type: entertainment,
  })
  @Get(':id_app')
  ...
  create(
    @Body() entertainment: entertainmentDtoInsert,
    @Req() req: Request,
  ): Promise<entertainment> {
    return this.entertainmentService.create(entertainment, req);
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'The entertainment has been successfully updated.',
    type: entertainment,
  })
  update(
    @Param('id_app') id_app: number,
    @Body() entertainment: entertainmentDtoInsert,
    @Req() req: Request,
  ) {
    return this.entertainmentService.update(id_app, entertainment, req);
  }
  ...
  @Delete(':id_app')
  remove(@Param('id_app') id: number, @Req() req: Request) {
    return this.entertainmentService.remove(id, req);
  }
  ...
  updateStatusActive(@Param('id_app') id_app: number, @Req() req: Request) {
    return this.entertainmentService.updateStatusActive(id_app, req);
  }
}

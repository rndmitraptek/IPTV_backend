...
export class InfoHotelController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Return all info_hotel.',
    type: [info_hotel],
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Return a single info_hotel.',
    type: info_hotel,
  })
  @Get(':id')
  ...
  create(
    @Body() info_hotel: info_hotelDtoInsert,
    @Req() req: Request,
  ): Promise<info_hotel> {
  ...
  @ApiResponse({
    status: 200,
    description: 'The info_hotel has been successfully updated.',
    type: info_hotel,
  })
  update(
    @Param('id') id: number,
    ...
    return this.info_hotelService.update(id, info_hotel, req);
  }
}

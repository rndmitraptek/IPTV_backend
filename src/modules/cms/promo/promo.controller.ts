...
export class PromoController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Return a single promo.',
    type: promo,
  })
  @Get(':id_promo')
  ...
  @ApiResponse({
    status: 200,
    description: 'The promo has been successfully updated.',
    type: promo,
  })
  update(
    @Param('id_promo') id_promo: string,
    @Body() promo: promoDtoInsert,
    @Req() req: Request,
  ) {
    return this.promoService.update(id_promo, promo, req);
  }
  ...
  @Delete(':id_promo')
  remove(@Param('id_promo') id: string, @Req() req: Request) {
    return this.promoService.remove(id, req);
  }
  ...
  updateStatusActive(
    ...
    return this.promoService.updateStatusActive(id_channel, req);
  }
}

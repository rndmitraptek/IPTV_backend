...
export class HotelController {
    ...
    create(@Body() iptv_feature: hotelDtoInsert, @Req() req:Request): Promise<iptv_feature> {
    ...
    update(@Param('id') id: number, @Body() iptv_feature: hotelDtoInsert,@Req() req:Request) {
    ...
    @ApiResponse({ status: 200, description: 'The iptv_feature has been successfully delete.' })

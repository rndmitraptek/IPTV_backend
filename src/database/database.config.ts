...
import { log_update_contentEntity } from './iptv/log_update_content.entity';
dotenv.config();
    ...
    let config: SequelizeModuleOptions = {
      ...
      port:
        req['tenant'] === undefined
          ...
          : parseInt(process.env.POSTGRES_PORT_TENANT), // replace with your database port
      ...
      database:
        req['tenant'] === undefined ? process.env.POSTGRES_DATABASE : 'tenant',
      models: models,
      define: {
        timestamps: false,
      },
